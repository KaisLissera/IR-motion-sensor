...
void Cli_t::PutHex(uint32_t number) {
	TxChannel->WriteToBuffer((uint8_t)'0');
	TxChannel->WriteToBuffer((uint8_t)'x');
	uint32_t mask = 0b1111 << 28;
	for(uint8_t i = 0; i < 32; i++) {
		uint8_t temp = number & mask;
		switch(temp){
		case 0:
			TxChannel->WriteToBuffer((uint8_t)'0');
			break;
		case 1:
			...
			break;
		case 2:
			TxChannel->WriteToBuffer((uint8_t)'2');
			break;
		case 3:
			TxChannel->WriteToBuffer((uint8_t)'3');
			break;
		case 4:
			TxChannel->WriteToBuffer((uint8_t)'4');
			break;
		case 5:
			TxChannel->WriteToBuffer((uint8_t)'5');
			break;
		case 6:
			TxChannel->WriteToBuffer((uint8_t)'6');
			break;
		case 7:
			TxChannel->WriteToBuffer((uint8_t)'7');
			break;
		case 8:
			TxChannel->WriteToBuffer((uint8_t)'8');
			break;
		case 9:
			TxChannel->WriteToBuffer((uint8_t)'9');
			break;
		case 10:
			TxChannel->WriteToBuffer((uint8_t)'A');
			break;
		case 11:
			TxChannel->WriteToBuffer((uint8_t)'B');
			break;
		case 12:
			TxChannel->WriteToBuffer((uint8_t)'C');
			break;
		case 13:
			TxChannel->WriteToBuffer((uint8_t)'D');
			break;
		case 14:
			TxChannel->WriteToBuffer((uint8_t)'E');
			break;
		case 15:
			TxChannel->WriteToBuffer((uint8_t)'F');
			break;
		}
		mask = mask >> 4;
	}
